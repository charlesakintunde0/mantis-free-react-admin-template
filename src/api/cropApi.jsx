...
export const {useGetDiseasesQuery ,useGetSpecificCropQuery,useGetAllCropsQuery, useDeleteCropMutation, useCreateCropsMutation, useUpdateCropMutation } = cropApi;