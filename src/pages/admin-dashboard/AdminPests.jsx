...
function AdminPests() {
    const { data } = useGetAllPestsQuery();
    ...
    return (
        <div className='adminMainDiv'>
            {curentlyLoggedInUser.isAdmin === userRole.ADMIN && <div className="addingForm addingForm1">
            ...
            {curentlyLoggedInUser && <div className="existingData">
            ...
            {curentlyLoggedInUser.isAdmin === userRole.ADMIN && <div className="existingData existingDataDB">
                <div className="adminHeading">
                    <h3>All the pests</h3>
